...
// Generated: 2025-08-20T01:45:58.702Z
// Section: cta
// Category: cta
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join the thousands of businesses who have streamlined their operations 
                and scaled their digital presence with our cutting-edge no-code platform.
              </p>
