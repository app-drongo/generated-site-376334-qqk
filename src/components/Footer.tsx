...
// Generated: 2025-08-20T01:45:58.232Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl">No Code Consulting</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Empowering businesses to thrive in the digital age with our no-code solutions and expert consulting services.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">info@nocodeconsulting.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest updates on our no-code services and industry insights. No spam, unsubscribe anytime.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 No Code Consulting. All rights reserved.</span>
